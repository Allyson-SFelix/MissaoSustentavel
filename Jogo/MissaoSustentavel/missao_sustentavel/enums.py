...
# Carregar imagens do personagem e monstro
IMAGEM_PERSONAGEM = pygame.image.load("assets/Personagem2d.png")
IMAGEM_MONSTRO = pygame.image.load("assets/Monstro2d.png")
